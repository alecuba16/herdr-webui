...
- Root Herdr app releases use `CHANGELOG.md` and root `v0.x.y` tags.
- WebUI-only releases use WebUI `v0.0.x` tags and GitHub Release notes generated by `.github/workflows/webui-release.yml`.
- Do not add WebUI-only changes to root `CHANGELOG.md` unless the root Herdr binary/version also changes.
