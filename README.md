...
| --- | --- | --- | --- | --- |
| `0.0.53` | `0.7.1+` | `14` | Current | Expanded Rust coverage around Git UI, app-state helpers, service command runner, file-browser edge paths, and README coverage notes. |
...
- GitHub Actions tag builds report release tag, for example `v0.0.53`.
