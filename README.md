...
| --- | --- | --- | --- | --- |
| `0.0.54` | `0.7.1+` | `14` | Current | Fixes Git panel rename status paths so unstaging/stash actions use the renamed file path instead of the `old -> new` display string. |
...
- GitHub Actions tag builds report release tag, for example `v0.0.54`.
