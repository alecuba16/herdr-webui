...
- Editor: CodeMirror loads on first editor use and is reused for previews and editing; shared editor code provides find in preview plus replace in edit mode.
