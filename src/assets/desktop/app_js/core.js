      ...
      <div class="modal">
        ...
        <section class="help-section">
          ...
          <div class="help-grid">
            ...
            <div class="help-row"><strong>Git</strong><span>Git selector opens repo tools for diff, stage/unstage, discard, commit, commit & push, pull, push/force-push, rebase, conflicts, stash, branches, cleanup, and worktree prune. Changes, log, stash, and cleanup use one exclusive segmented toggle; the file filter sits below the action toolbar; the Commit button appears only when there are changes; changed-file sections include add all/remove all pills next to their counters. File view can toggle unified/side-by-side diffs, and log rows show branch/ref labels beside the graph.</span></div>
