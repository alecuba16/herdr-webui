...
function normalizeOptions(value) {
  ...
  // Migrate pre-Ghostty-default stored blobs to the new default once. See
  // resolveTerminalCoreChoice in shared/core.js: browsers that saved while
  // wterm was default carry terminalCore:"wterm" without ever choosing it.
  const terminalCoreMigrated = next.terminalCoreGhosttyMigrated === true;
  next.terminalCore = HerdrAppHelpers.resolveTerminalCoreChoice(
    next.terminalCore,
    terminalCoreMigrated,
  );
