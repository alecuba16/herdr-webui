      ...
      <div class="modal">
        ...
        <section class="help-section">
          ...
          <div class="help-grid">
            ...
            <div class="help-row"><strong>Git</strong><span>Git selector opens repo tools for diff, stage/unstage, discard, commit, commit & push, pull, push/force-push, rebase, conflicts, stash, branches, cleanup, and worktree prune. Changes, log, stash, and cleanup use one exclusive segmented toggle; the file filter sits below the action toolbar. File view can toggle unified/side-by-side diffs.</span></div>
