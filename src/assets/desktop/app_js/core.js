      ...
      <div class="modal">
        ...
        <section class="help-section">
          ...
          <div class="help-grid">
            ...
            <div class="help-row"><strong>Files</strong><span>Files selector opens browser/editor; ... goes up; file/folder rows use Zed-like, license-safe type icons; search can target files or folders and keeps parent folders visible so result paths stay clear. Text previews use the same CodeMirror editor surface as edit mode but stay read-only until Edit is pressed; line numbers show by default, fold controls work for supported languages, and syntax colors use dedicated high-contrast light/dark editor palette tokens. Search, selected files, split panes, and unsaved edit drafts stay attached to each open workspace/worktree while switching panels; closing the workspace/worktree forgets them. Git colors are computed server-side and propagate up directories with priority red deleted, yellow modified, green new.</span></div>
