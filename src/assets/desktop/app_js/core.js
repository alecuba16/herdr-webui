      ...
      <div class="modal">
        ...
        <section class="help-section">
          ...
          <div class="help-grid">
            ...
            <div class="help-row"><strong>Git</strong><span>Git selector opens repo tools for diff, stage/unstage, discard, commit, commit & push, pull, push, rebase, conflicts, stash, branches, cleanup, and worktree prune. Changes, log, stash, and cleanup use one exclusive segmented toggle; the file filter sits below the action toolbar; the Commit button appears only when there are changes; Push starts regular and offers force-with-lease/force only after Git rejects it; changed-file sections include add all/remove all pills next to their counters. File view can toggle unified/side-by-side diffs, and log rows show branch/ref labels as horizontal shadows beside the graph/message row.</span></div>
...
const shortcutEditorGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["blame", "Blame"],
      ["edit", "Edit file"],
      ["compare", "Return to current changes"],
