      ...
      <div class="modal">
        ...
        <section class="help-section">
          ...
          <div class="help-grid">
            ...
            <div class="help-row"><strong>Search</strong><span>Prefix then / or the header magnifier opens one palette for workspaces, repos, worktrees, labels, agents, panels, file/folder results, and file-content matches. In search, arrows move, Enter opens, Esc closes, Alt+F selects files, Alt+D selects folders, Alt+1/2/3 toggles sections, and Alt+↑/↓ expands content context for the selected match.</span></div>
