...
describe("app bundle load", () => {
  ...
  it("renders shortcut editor with collision detection", () => {
    ...
    match(html, /terminal links open in browser when enabled/);
    match(html, /Git selector opens repo tools for diff, stage\/unstage, discard, commit, stash, branches, cleanup, and worktree prune/);
