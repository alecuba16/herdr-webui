...
describe("app boot", () => {
  ...
  it("loads desktop bundle by default on wide screens", () => {
    ...
    equal(links[3].href, "/assets/shared/file-tree.css");
    equal(links[4].href, "/assets/shared/colors.css");
    equal(links[5].href, "/assets/shared/file-icons.css");
    equal(links[6].href, "/assets/shared/content-search.css");
    ...
    equal(links[7].href, "/assets/desktop/git-ui.css");
    equal(links[8].href, "/assets/desktop/file-browser.css");
    equal(links.length, 9);
