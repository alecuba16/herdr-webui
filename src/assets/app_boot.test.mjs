...
describe("app boot", () => {
  ...
  it("loads desktop bundle by default on wide screens", () => {
    ...
    equal(scripts[3].src, "/assets/shared/line-context.js");
    equal(scripts[4].src, "/assets/shared/file-content-search.js");
    equal(scripts[5].src, "/assets/shared/workspace-search.js");
